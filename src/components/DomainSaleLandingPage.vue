        ...
        <div class="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md mb-12">
          ...
          <div class="mb-4">
            <p class="text-gray-700 dark:text-gray-300">
              Eğitim, bilgi paylaşım, haber platformları için mükemmel bir seçim.
            </p>
          </div>
          ...
          <button
            @click="contactSeller({ name: 'ilkbilgi.com' })"
...
const domains = ref([
  ...
  {
    name: 'vendso.com',
    description: 'SaaS çözümleri ve yazılım satış platformları için ideal.'
  },
  {
    name: 'doluyer.com',
